    ...
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Irisdahlsvej 32", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Århus N", null, "Tine", "Petterson", "8200" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Book", "Book", "A_Hard_Days_Write.jpg", 150.00m, "A Hard Day's Write: The Stories BehindEvery Beatles Song ", "Steve Turner", "978-0060844097", (short)2005, "It Books" },
                    { 2, "Book", "Book", "The Making of Sgt.Pepper.jpg", 180.00m, "With a Little Help from My Friends: TheMaking of Sgt.Pepper", "Georg Martin", "0316547832", (short)1995, "Little Brown & Co" }
                });
