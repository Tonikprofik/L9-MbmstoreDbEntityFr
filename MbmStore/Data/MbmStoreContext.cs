    ...
    public class MbmStoreContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>().HasData(
                ...
                {
                    ProductId = 1,
                    Title = "A Hard Day's Write: The Stories Behind" +
                "Every Beatles Song ",
                    Author = "Steve Turner",
                    Price = 150.00M,
                    Publisher = "It Books",
                ...
                {
                    ProductId = 2,
                    Title = "With a Little Help from My Friends: The" +
